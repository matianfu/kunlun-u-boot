...
omap3630kunlun_config :    unconfig
	@./mkconfig $(@:_config=) arm omap3 omap3630kunlun
	cp ./tools/logos/via.bmp ./tools/logos/logo.bmp

omap3630kl9c_config :    unconfig
	@./mkconfig $(@:_config=) arm omap3 omap3630kunlun
	sed 's/kl9c.h/kunlun.h/;/#include/i #define CONFIG_3630KUNLUN_KL9C 1' < \
	./include/config.h > ./include/config-2.h; \
	mv ./include/config-2.h ./include/config.h
	cp ./tools/logos/via.bmp ./tools/logos/logo.bmp

omap3630wudang_config :    unconfig
	@./mkconfig $(@:_config=) arm omap3 omap3630kunlun
	sed 's/wudang.h/kunlun.h/;/#include/i #define CONFIG_3630KUNLUN_WUDANG 1' < \
	./include/config.h > ./include/config-2.h; \
	mv ./include/config-2.h ./include/config.h
	cp ./tools/logos/via.bmp ./tools/logos/logo.bmp

omap3630jt_config :    unconfig
	@./mkconfig $(@:_config=) arm omap3 omap3630kunlun
	sed 's/jt.h/kunlun.h/;/#include/i #define CONFIG_3630KUNLUN_JT 1' < \
	./include/config.h > ./include/config-2.h; \
	mv ./include/config-2.h ./include/config.h
	cp ./tools/logos/jt.bmp ./tools/logos/logo.bmp

omap3630kunlunp2_config :    unconfig
	@./mkconfig $(@:_config=) arm omap3 omap3630kunlun
	sed 's/kunlunp2.h/kunlun.h/;/#include/i #define CONFIG_3630KUNLUN_P2 1' < \
	./include/config.h > ./include/config-2.h; \
	mv ./include/config-2.h ./include/config.h
	cp ./tools/logos/via.bmp ./tools/logos/logo.bmp
