...
#define MUX_DEFAULT_ES2()\
	...
	MUX_VAL(CP(CAM_D8 ),        (IEN  | PTD | EN  | M4)) /*CAM_PWDN GPIO_107*/\
	MUX_VAL(CP(CAM_D9 ),        (IDIS | PTD | DIS | M7)) /*TBD PIN*/\
	MUX_VAL(CP(CAM_D10),        (IDIS | PTU | EN  | M4)) /*BT_RST_N GPIO_109*/\
	MUX_VAL(CP(CAM_D11),        (IDIS | PTD | DIS | M7)) /*TBD PIN*/\
	MUX_VAL(CP(CAM_XCLKB),      (IDIS | PTD | DIS | M7)) /*TBD PIN*/\
	...
	/*spi2 TBD */\
	MUX_VAL(CP(McSPI2_CLK),     (IDIS  | PTD | DIS | M7)) /*TBD PIN*/\
	MUX_VAL(CP(McSPI2_SIMO),    (IDIS  | PTD | DIS | M7)) /*TBD PIN*/\
	MUX_VAL(CP(McSPI2_SOMI),    (IDIS  | PTD | DIS | M7)) /*TBD PIN*/\
	...
	/*WLAN*/\
	MUX_VAL(CP(ETK_CLK_ES2),    (IDIS | PTD | DIS | M7)) /*TBD PIN*/\
	MUX_VAL(CP(ETK_CTL_ES2),    (IDIS | PTD | DIS | M7)) /*TBD PIN*/\
	...
	MUX_VAL(CP(ETK_D11_ES2),    (IDIS | PTD | DIS | M7)) /*TP317*/\
