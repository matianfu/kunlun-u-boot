...
#define 	REG_SW1AVG_MSB	       0x09
#define 	SW1_CH9_SEL		(0x02)
#define   SW1_CH11_SEL          (0x08)
...
#define REG_GPCH11		(TWL4030_BASEADD_MADC + 0x04D)
#define REG_GPCH12		(TWL4030_BASEADD_MADC + 0x04F)
...
#define REG_PWR_IMR1 (TWL4030_BASEADD_INT + 0x01)
#define REG_PWR_EDR1 (TWL4030_BASEADD_INT + 0x05)
/*
...
#define DEFAULT_CHARGE_CURRENT  (450)  /*mA*/
